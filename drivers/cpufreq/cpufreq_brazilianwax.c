		...
		unsigned int event)
{
	...
	case CPUFREQ_GOV_START:
		...
		this_brazilianwax->cur_policy->max = CONFIG_MSM_CPU_FREQ_ONDEMAND_MAX;
		this_brazilianwax->cur_policy->min = CONFIG_MSM_CPU_FREQ_ONDEMAND_MIN;
		this_brazilianwax->cur_policy->cur = CONFIG_MSM_CPU_FREQ_ONDEMAND_MAX;
